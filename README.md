...
## 🎉 使用
### 指令表
- 输入:/CF 或 /cf 或 /查CF 或 /查cf 即可进行查询近期比赛
- 在好友私聊下输入:/绑定 你的CF个人ID 即可对该账户分数进行监测(一个ID只能绑定一个QQ号)
- 在群聊下输入:/群提醒 即可对本群开启比赛提醒功能(分别在48小时，11小时，3小时提醒一次)
- 在群聊下输入:/取消群提醒 即可关闭本群的比赛提醒功能
- 在好友私聊下输入:/提醒 即可开启比赛提醒功能(分别在48小时，11小时，3小时提醒一次)
- 在好友私聊下输入:/取消提醒 即可关闭比赛提醒功能
